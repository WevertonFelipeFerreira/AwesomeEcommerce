    ...
    public class AddOrder : IRequest<Guid>
    {
        ...
        public Order ToEntity()
        {
            return new Order(
                ...
                new DeliveryAddress(DeliveryAddress.Street, DeliveryAddress.City, DeliveryAddress.Number, DeliveryAddress.State, DeliveryAddress.ZipCode),
                new PaymentAddress(PaymentAddress.Street, PaymentAddress.City, PaymentAddress.Number, PaymentAddress.State, PaymentAddress.ZipCode),
                new PaymentInfo(PaymentInfo.FullName, PaymentInfo.CardNumber, PaymentInfo.Expiration, PaymentInfo.Cvv),
